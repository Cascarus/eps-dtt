(function($, undefined) {
  $.web2py.ajax_fields = function(target) {
    ...
    $('button:not([class^="btn"])', target).addClass('btn btn-primary');
    $("p.w2p-autocomplete-widget input").addClass('form-control');
    $('form input[type="submit"]:not([class^="btn"]), form input[type="button"]:not([class^="btn"])', target).addClass('btn btn-primary');
